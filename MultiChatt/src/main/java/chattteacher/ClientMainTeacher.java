...
public class ClientMainTeacher extends JFrame {
	ClientThreadTeacher ct;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClientMainTeacher frame = new ClientMainTeacher();
	...
	public void connect() {
		try {
			...
			ct = new ClientThreadTeacher(s, this);// ClientMain.this
			ct.start();
	...
	public void disconnect() {
		...
		obj.put("command", ServerMainTeacher.LOGOUT);
