...
$('#btnAjax').on('click', function() {
	$('main>div#content').load('ajax.jsp');
});

/* jquery/ajax.jsp */
$('#btnSerialize').on('click', function() {
	$('main>div#content').load('serialize.jsp');
});

/* jquery/multipart.jsp */
$('#btnMultipart').on('click', function() {
	$('main>div#content').load('multipart_form.jsp');
});
