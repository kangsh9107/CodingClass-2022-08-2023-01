...
<div class='main_member_control'>
	...
	<form class='frm_member_control' name='frm_member' enctype="multipart/form-data" method="post" action="memberUpload.do">
		<div id='left_member_control'>
			<input type='file' name="att" id='photo_file_member_control'/>
