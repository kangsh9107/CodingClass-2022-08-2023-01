...
<div class='stdInputWrap'>
	<form class='stdInput' name='stdInput' method='post' action='register.do'>
		<h2>학생정보 입력</h2><br/>
		<span>아이디</span>
		...
		<span>암호</span>
		<input type='password' name='pwd' size='30' onchange='ChkPwd(this.form)'/><br/>
		<span>암호 확인</span>
		<input type='password' name='pwd2' size='30' onchange='ChkPwd(this.form)'/><br/>
		<span>연락처</span>
